...
> Bundled at planting time on 2026-05-09T12:53:26Z. The authoritative source is the parent repo; this is the self-contained subset every planting needs.
...
For this neighborhood: `id` = `@kody-w/rapp-test-neighbor`.
